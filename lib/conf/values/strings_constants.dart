abstract class MyStrings {
  //
  static String get appName => 'Exchange Rate';

  static String get refreshingRates =>
      'Updating rates for currencies with random values...';
  static String get currency => 'Currency';
  static String get currencies => 'Currencies';
  static String get loading => 'Loading...';
  static String get rates => 'Rates';
  ...
  static String get wednesday => 'Wednesday';
  static String get thursday => 'Thursday';
  static String get friday => 'Friday';
  static String get saturday => 'Saturday';
  static String get sunday => 'Sunday';
  ...
  static String get routingErrorTitle => 'Routing Error';
  static String get routingErrorDesc => 'Fix route_generator.dart';
